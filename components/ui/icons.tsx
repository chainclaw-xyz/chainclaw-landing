...
export function GithubIcon({ size: s = 20 }: { size?: number }) {
  return (
...
export function SkillIcon({ icon }: { icon: string }) {
  return (
    <div className="w-9 h-9 rounded-lg bg-neutral-100 flex items-center justify-center text-sm font-mono text-neutral-600">
      {skillIcons[icon] || "\u25CB"}
    </div>
  );
}
